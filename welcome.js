...
setTimeout(function () {
	...
	PKAudioEditor._deps.Wlc = function () {
			...
			if (PKAE.isMobile) {
				...
				body_str2 = ''; // checkout the code on github
			}

			// Welcome to AudioSpace,
			var md = new PKSimpleModal({
				title: '<font style="font-size:15px">Welcome to AudioSpace</font>',
			...
			body:'<div style="overflow:auto;-webkit-overflow-scrolling:touch;max-width:580px;width:calc(100vw - 40px);max-height:calc(100vh - 340px);min-height:110px;font-size:13px; color:#95c6c6;padding-top:7px;">'+
				'AudioSpace is a free, open source, web-based Audio and Waveform Editor.<br />It runs entirely in the browser with no backend and no plugins required!'+
				'<br/><br/><br/>'+
				body_str+
